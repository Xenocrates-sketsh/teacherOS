    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="glass-card p-6">
        <div className="mb-6 p-4 bg-surface rounded-lg">
          <h3 className="font-medium text-[#f8f4ff] mb-1">{homework.title}</h3>
          {homework.description && (
            <p className="text-sm text-[#9d8ab5]">{homework.description}</p>
          )}
          {homework.due_date && (
            <p className="text-sm text-[#7b6b8d] mt-2">
        ...
        {existingSubmission && (
          <div className="mb-6 p-4 bg-green-500/100/100/100/100/100/100/10 rounded-lg flex items-center gap-2 text-green-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-[rgba(212,175,55,0.15)] px-3 py-2 text-sm focus:ring-2 focus:ring-gold-500 focus:border-gold-500"
            />
          </div>
