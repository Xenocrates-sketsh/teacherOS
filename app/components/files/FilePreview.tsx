  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 text-sm link-gold transition-colors"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-surface-card/80 backdrop-blur-xl rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-[rgba(212,175,55,0.08)]">
              <h3 className="text-sm font-medium text-[#f8f4ff] truncate">{fileName || "File Preview"}</h3>
              <div className="flex items-center gap-2">
                <a
                  href={url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-1.5 text-[#6b5b7d] hover:text-[#9d8ab5] transition-colors"
                >
            ...
            <div className="flex-1 overflow-auto p-6 bg-surface flex items-center justify-center min-h-[300px]">
              {isImage ? (
                ...
                <div className="text-center text-[#7b6b8d]">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-4 inline-flex items-center gap-2 link-gold"
                  >
                    <Download className="w-4 h-4" />
                    Download to view
                  </a>
